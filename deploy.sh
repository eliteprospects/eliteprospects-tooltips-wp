...
# main config
PLUGINSLUG="eliteprospects-tooltips"
CURRENTDIR=`pwd`
...
SVNURL="http://plugins.svn.wordpress.org/eliteprospects-tooltips/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="carlgrundberg" # your svn username
